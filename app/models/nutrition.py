...
class MealPlan(UUIDMixin, TimestampMixin, Base):
    ...
    # "auto" — generated by `app.services.meal_planner` from the client's numbers.
    # "manual" — written (or edited) by the coach. An edit flips an auto plan to
    # manual, so the coach's changes are never regenerated away.
